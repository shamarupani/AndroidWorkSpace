...
class MainActivity2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        text2.setOnClickListener {
            Toast.makeText(applicationContext, "₹314", Toast.LENGTH_LONG).show()
        }
        ...
        text3.setOnClickListener {
            Toast.makeText(applicationContext,"₹499",Toast.LENGTH_LONG).show()
        }
        ...
        text4.setOnClickListener {
            Toast.makeText(applicationContext,"₹1499",Toast.LENGTH_LONG).show()
        }
        ...
        text5.setOnClickListener {
            Toast.makeText(applicationContext,"₹265",Toast.LENGTH_LONG).show()
        }
        ...
        text6.setOnClickListener {
            Toast.makeText(applicationContext,"₹299",Toast.LENGTH_LONG).show()
        }
    }
